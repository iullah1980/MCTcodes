...
for (i in 1:length(n1)){
  for (j in 1:length(n2)){
    for (k in 1:length(sd2)){
      pow.v1 <- BF.sim(n1[i], n2[j], mu1, mu2, sd1, sd2[k],size, n.replicate)
      M1[i, j, k] <- pow.v1[1]
      M2[i, j, k] <- pow.v1[2]
    }
  }
...
emp <- c("","","","","","","","","","","","","","","","","","",
         "","","","","","","","","","","","","","","","","","",
         "","","","","","","","","")
load("C:\\Users\\ullahi\\Dropbox\\little paper sim\\s1.Rdata")
R1 <- cbind(c(M[[1]][1,1,],M[[1]][2,2,],M[[1]][3,3,],M[[1]][4,4,],M[[1]][5,5,]),
            c(M[[2]][1,1,],M[[2]][2,2,],M[[2]][3,3,],M[[2]][4,4,],M[[2]][5,5,]))
R1 <- round(R1,3)

load("C:\\Users\\ullahi\\Dropbox\\little paper sim\\s5.Rdata")
R2 <- cbind(c(M[[1]][1,1,],M[[1]][2,2,],M[[1]][3,3,],M[[1]][4,4,],M[[1]][5,5,]),
            c(M[[2]][1,1,],M[[2]][2,2,],M[[2]][3,3,],M[[2]][4,4,],M[[2]][5,5,]))
R2 <- round(R2,3)

load("C:\\Users\\ullahi\\Dropbox\\little paper sim\\s10.Rdata")
