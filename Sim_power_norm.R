...
emp <- c("","","","","","","","","","","","","","","","","","",
         "","","","","","","","","","","","","","","","","","",
         "","","","","","","","","")
load("C:\\Users\\ullahi\\Dropbox\\little paper sim\\p1.Rdata")
R1 <- cbind(c(M[[1]][1,1,],M[[1]][2,2,],M[[1]][3,3,],M[[1]][4,4,],M[[1]][5,5,]),
            c(M[[2]][1,1,],M[[2]][2,2,],M[[2]][3,3,],M[[2]][4,4,],M[[2]][5,5,]))
R1 <- round(R1,3)

load("C:\\Users\\ullahi\\Dropbox\\little paper sim\\p2.Rdata")
R2 <- cbind(c(M[[1]][1,1,],M[[1]][2,2,],M[[1]][3,3,],M[[1]][4,4,],M[[1]][5,5,]),
            c(M[[2]][1,1,],M[[2]][2,2,],M[[2]][3,3,],M[[2]][4,4,],M[[2]][5,5,]))
R2 <- round(R2,3)

load("C:\\Users\\ullahi\\Dropbox\\little paper sim\\p3.Rdata")
